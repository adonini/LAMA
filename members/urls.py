...
urlpatterns = [
    ...
    path('api/get-member-duty/', views.get_member_duty, name='get_member_duty'),
    path('api/get-duty-list/', views.get_duty_list, name='get_duty_list'),
    ...
    path('duties/<int:pk>/', views.DutyRecord.as_view(), name='duty-record'),
    path('duties/show_end_modal/', views.show_end_modal, name='show_end_modal'),
    path('members/show_end_modal/', views.show_end_modal, name='show_end_modal'),
]
