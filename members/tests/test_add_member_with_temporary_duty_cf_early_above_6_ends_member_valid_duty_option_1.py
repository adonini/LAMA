...
def test_add_member_with_temporary_duty_cf_early_above_6_ends_member_valid_duty_option_1(client):
    ...
    assert member.dated_authorship(datetime(2025, 5, 5).date()) is not None
