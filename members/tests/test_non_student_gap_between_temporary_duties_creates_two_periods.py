...
def test_non_student_gap_between_temporary_duties_creates_two_periods():
    institute = Institute.objects.create(name="Institute Test")
    member = Member.objects.create(
        name="Researcher",
        surname="Gap",
        primary_email="non-student-gap@test.com",
        role="affiliated",
    )
    ...
    duty_1 = Duty.objects.create(name="Temporary Duty 1", duty_type=temporary_type)
    duty_2 = Duty.objects.create(name="Temporary Duty 2", duty_type=temporary_type)
